        ...
        t=$(".kt-datatable").KTDatatable( {
            ...
            , {
                field:"Status", title:"Status", autoHide:!1, template:function(t) {
                    var e= {
                        0: {
                            title: "Pending", class: "kt-badge--warning"
                        }
                        , 1: {
                            title: "Success", class: " kt-badge--success"
                        }
                        , 2: {
                            title: "Processing", class: " kt-badge--warning"
                        }
                        , 3: {
                            title: "Rejected", class: " kt-badge--danger"
                        }
                        , 4: {
                            title: "Success", class: " kt-badge--success"
                        }
            ...
            , {
                field:"Type", title:"Type", autoHide:!1, template:function(t) {
                    var e= {
                        ...
                        , cr: {
                            title: "Credit", state: "success"
                        }
                        , db: {
                            title: "Debit", state: "brand"
                        }
                        , 3: {
