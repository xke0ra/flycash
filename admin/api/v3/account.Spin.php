...
if (!empty($_POST)) {
    ...
    $sql = "SELECT * FROM tracker WHERE user_id = :uid AND type = :spinRewardTitle ORDER BY id DESC LIMIT 1";
    $stmt = $dbo->prepare($sql);
    $stmt->execute(array(':uid' => $accountId, ':spinRewardTitle' => $spinRewardTitle));
